    ...
    <body class="d-flex align-items-center py-4 bg-body-tertiary">
        ...
        <h1 class="h3 mb-3 fw-normal">Sistema de Gestão de Certificados Eletrônicos </h1>
            ...
            <form action="login.php" method="$_POST">
                ...
                <h1 class="h3 mb-3 mt-2 fw-normal"> Cadastro de Usuário </h1>
                ...
                <div class="form-floating mt-2">
                    ...
                    <input type="password" class="form-control" id="floatinInput" placeholder="Confirmar Senha">
                    <label for="floatinInput">Confirmar Senha</label>
